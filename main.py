...
class Main(Login, Admin, User):
    ...
    def buildmain(self):
        ...
        title = Label(canvas_top, text="RTPM-DSHS CANTEEN INVENTORY", bg=TOP_NAV_COLOR, font=('Century', 30, 'normal'))
        title.place(x=1, y=10)
        ...
        if int(strftime('%H')) >= 17:
            index = 2
        self.wish_lbl = Label(self.canvas_date, text=f"Good {wish[index]}, Sir!", bg=BG, fg=FG,
